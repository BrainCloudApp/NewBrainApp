package com.lmq.im.chatroom.thridparty;
...
import com.lmq.im.DemoServers;
import com.lmq.im.chatroom.helper.ExtensionHelper;
...
public class ChatRoomHttpClient {
    ...
    private ChatRoomHttpClient() {
        NimHttpClient.getInstance().init(Appstorage.getContext());
    }
    ...
    private String readAppKey() {
        try {
            ApplicationInfo appInfo = Appstorage.getContext().getPackageManager()
                    .getApplicationInfo(Appstorage.getContext().getPackageName(), PackageManager.GET_META_DATA);
            if (appInfo != null) {
