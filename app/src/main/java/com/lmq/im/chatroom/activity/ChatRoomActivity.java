package com.lmq.im.chatroom.activity;
...
import com.lmq.im.chatroom.fragment.ChatRoomFragment;
            ...
            if (chatRoomStatusChangeData.status == StatusCode.CONNECTING) {
                ...
                if (hasEnterSuccess) {
                   ...
                   // ToastHelper.showToast(ChatRoomActivity.this, "getEnterErrorCode=" + code);
                    Toast.makeText(ChatRoomActivity.this,"getEnterErrorCode=" + code,Toast.LENGTH_SHORT).show();
